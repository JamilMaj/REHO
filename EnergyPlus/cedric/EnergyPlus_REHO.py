...
if __name__ == '__main__':
    ...
    directory = r'C:\Users\cterrier\Desktop\DesignBuilder_models'
    idf_relative_filepath = directory + '\CELL.idf'
    epw_relative_filepath = directory + '\CHE_Geneva.epw'  #
    output_relative_directory = directory + '\output'
    ...
    df = pd.read_csv(output_relative_directory+'\eplusout.csv', parse_dates=[0], index_col=[0], date_parser=parse_energyplus_datetime_string)
